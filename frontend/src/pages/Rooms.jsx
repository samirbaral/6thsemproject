...
const Rooms = () => {
  ...
  if (loading) {
    return <div className="page flex items-center justify-center py-20">Loading...</div>;
  }
          ...
          {rooms.map((room) => (
            ...
            {room.images && room.images.split(',')[0] && (
              ...
              <div className="p-4">
                ...
                <p className="text-lg font-bold text-orange-600 mb-4">${room.monthly_rent}/month</p>
